    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Cennosti a malé předměty',
        features: [
          'Rozměry: 17×20×50 cm',
          '👜 Kabelka / malá taška',
          '📱 Telefon, klíče, peněženka',
          '🛂 Cestovní pas a doklady',
          '🕶️ Pouzdro na brýle, malý balík',
        ],
      },
      {
        name: 'Skříňka M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 kabinová zavazadla + batoh',
        features: [
          'Rozměry: 60×50×60 cm',
          '🧳 2 kabinová zavazadla (55×40×23 cm)',
          '🎒 1 batoh',
          'Vše se vejde celé, bez vyčnívání',
          'Ideální pro páry nebo krátký výlet',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 kabinová zavazadla + batoh',
        features: [
          'Rozměry: 60×50×80 cm',
          '🧳 3 kabinová zavazadla (55×40×23 cm)',
          '🎒 1 batoh',
          'Vše se vejde celé, bez vyčnívání',
          'Ideální pro skupiny nebo delší pobyt',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4.8',
        description: 'Valuables & small items',
        features: [
          'Dimensions: 17×20×50 cm',
          '👜 Handbag / small bag',
          '📱 Phone, keys, wallet',
          '🛂 Passport & documents',
          '🕶️ Glasses case, small parcel',
        ],
      },
      {
        name: 'Locker M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7.6',
        description: '2 cabin bags + backpack',
        features: [
          'Dimensions: 60×50×60 cm',
          '🧳 2 cabin suitcases (55×40×23 cm)',
          '🎒 1 backpack',
          'Everything fits fully inside',
          'Perfect for couples or day trips',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8.8',
        description: '3 cabin bags + backpack',
        features: [
          'Dimensions: 60×50×80 cm',
          '🧳 3 cabin suitcases (55×40×23 cm)',
          '🎒 1 backpack',
          'Everything fits fully inside',
          'Perfect for groups or longer stays',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Wertsachen & kleine Gegenstände',
        features: [
          'Maße: 17×20×50 cm',
          '👜 Handtasche / kleine Tasche',
          '📱 Handy, Schlüssel, Geldbörse',
          '🛂 Reisepass & Dokumente',
          '🕶️ Brillenetui, kleines Paket',
        ],
      },
      {
        name: 'Schließfach M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 Kabinentaschen + Rucksack',
        features: [
          'Maße: 60×50×60 cm',
          '🧳 2 Kabinenkoffer (55×40×23 cm)',
          '🎒 1 Rucksack',
          'Alles passt vollständig hinein',
          'Ideal für Paare oder Tagesausflüge',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 Kabinentaschen + Rucksack',
        features: [
          'Maße: 60×50×80 cm',
          '🧳 3 Kabinenkoffer (55×40×23 cm)',
          '🎒 1 Rucksack',
          'Alles passt vollständig hinein',
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Kosztowności i małe przedmioty',
        features: [
          'Wymiary: 17×20×50 cm',
          '👜 Torebka / mała torba',
          '📱 Telefon, klucze, portfel',
          '🛂 Paszport i dokumenty',
          '🕶️ Etui na okulary, mała paczka',
        ],
      },
      {
        name: 'Schowek M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 bagaże kabinowe + plecak',
        features: [
          'Wymiary: 60×50×60 cm',
          '🧳 2 walizki kabinowe (55×40×23 cm)',
          '🎒 1 plecak',
          'Wszystko mieści się w całości',
          'Idealny dla par lub jednodniowych wycieczek',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 bagaże kabinowe + plecak',
        features: [
          'Wymiary: 60×50×80 cm',
          '🧳 3 walizki kabinowe (55×40×23 cm)',
          '🎒 1 plecak',
          'Wszystko mieści się w całości',
          'Idealny dla grup lub dłuższych pobytów',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Цінності та дрібні речі',
        features: [
          'Розміри: 17×20×50 см',
          '👜 Сумочка / маленька сумка',
          '📱 Телефон, ключі, гаманець',
          '🛂 Паспорт і документи',
          '🕶️ Футляр для окулярів, маленька посилка',
        ],
      },
      {
        name: 'Камера M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 ручні валізи + рюкзак',
        features: [
          'Розміри: 60×50×60 см',
          '🧳 2 ручні валізи (55×40×23 см)',
          '🎒 1 рюкзак',
          'Все поміщається повністю',
          'Ідеально для пар або денних поїздок',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 ручні валізи + рюкзак',
        features: [
          'Розміри: 60×50×80 см',
          '🧳 3 ручні валізи (55×40×23 см)',
          '🎒 1 рюкзак',
          'Все поміщається повністю',
          'Ідеально для груп або тривалого перебування',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Objets de valeur & petits articles',
        features: [
          'Dimensions: 17×20×50 cm',
          '👜 Sac à main / petit sac',
          '📱 Téléphone, clés, portefeuille',
          '🛂 Passeport & documents',
          '🕶️ Étui à lunettes, petit colis',
        ],
      },
      {
        name: 'Casier M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 bagages cabine + sac à dos',
        features: [
          'Dimensions: 60×50×60 cm',
          '🧳 2 valises cabine (55×40×23 cm)',
          '🎒 1 sac à dos',
          'Tout rentre entièrement',
          'Idéal pour les couples ou excursions',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 bagages cabine + sac à dos',
        features: [
          'Dimensions: 60×50×80 cm',
          '🧳 3 valises cabine (55×40×23 cm)',
          '🎒 1 sac à dos',
          'Tout rentre entièrement',
          'Idéal pour les groupes ou longs séjours',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Objetos de valor & artículos pequeños',
        features: [
          'Dimensiones: 17×20×50 cm',
          '👜 Bolso / bolsa pequeña',
          '📱 Teléfono, llaves, cartera',
          '🛂 Pasaporte y documentos',
          '🕶️ Estuche de gafas, paquete pequeño',
        ],
      },
      {
        name: 'Taquilla M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 maletas de cabina + mochila',
        features: [
          'Dimensiones: 60×50×60 cm',
          '🧳 2 maletas de cabina (55×40×23 cm)',
          '🎒 1 mochila',
          'Todo cabe completamente',
          'Ideal para parejas o excursiones',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 maletas de cabina + mochila',
        features: [
          'Dimensiones: 60×50×80 cm',
          '🧳 3 maletas de cabina (55×40×23 cm)',
          '🎒 1 mochila',
          'Todo cabe completamente',
          'Ideal para grupos o estancias largas',
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        dailyPrice: '119',
        dailyPriceEur: '4,8',
        description: 'Oggetti di valore & piccoli articoli',
        features: [
          'Dimensioni: 17×20×50 cm',
          '👜 Borsetta / piccola borsa',
          '📱 Telefono, chiavi, portafoglio',
          '🛂 Passaporto e documenti',
          '🕶️ Custodia occhiali, piccolo pacco',
        ],
      },
      {
        name: 'Armadietto M',
        ...
        dailyPrice: '199',
        dailyPriceEur: '7,6',
        description: '2 bagagli a mano + zaino',
        features: [
          'Dimensioni: 60×50×60 cm',
          '🧳 2 valigie cabina (55×40×23 cm)',
          '🎒 1 zaino',
          'Tutto entra completamente',
          'Ideale per coppie o gite',
        ],
        popular: true,
      },
      {
        ...
        dailyPrice: '239',
        dailyPriceEur: '8,8',
        description: '3 bagagli a mano + zaino',
        features: [
          'Dimensioni: 60×50×80 cm',
          '🧳 3 valigie cabina (55×40×23 cm)',
          '🎒 1 zaino',
          'Tutto entra completamente',
          'Ideale per gruppi o soggiorni lunghi',
        ],
      },
    ],
