import { Smartphone, DollarSign, Headphones, Lock, Zap, MapPin, Bell, Clock } from 'lucide-react';
...
const translations = {
  cs: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Notifikace před vypršením',
        description: 'Obdržíte upozornění před koncem nájmu, takže budete vždy informováni a připraveni.',
      },
      {
        icon: 'clock',
        title: '30 min. toleranční doba',
        description: 'Pokud se zpozdíte až o 30 minut, nebude vám účtován žádný poplatek. Máte čas bez stresu.',
      },
      {
        icon: 'headphones',
        title: 'Podpora 24/7',
  ...
  en: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Rental Ending Notification',
        description: 'Get notified before your rental period ends, so you\'re always informed and prepared.',
      },
      {
        icon: 'clock',
        title: '30 Min. Grace Period',
        description: 'If you\'re late up to 30 minutes, no charge applies. Peace of mind with extra time.',
      },
      {
        icon: 'headphones',
        title: '24/7 Support',
  ...
  de: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Benachrichtigung vor Ende',
        description: 'Sie werden benachrichtigt, bevor Ihre Mietzeit endet, damit Sie immer informiert sind.',
      },
      {
        icon: 'clock',
        title: '30 Min. Kulanzzeit',
        description: 'Wenn Sie bis zu 30 Minuten zu spät sind, fallen keine Gebühren an. Stressfrei mit Extrazeit.',
      },
      {
        icon: 'headphones',
        title: '24/7 Support',
  ...
  pl: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Powiadomienie przed końcem',
        description: 'Otrzymasz powiadomienie przed końcem wynajmu, więc zawsze będziesz poinformowany.',
      },
      {
        icon: 'clock',
        title: '30 min. okres tolerancji',
        description: 'Jeśli spóźnisz się do 30 minut, nie zostaniesz obciążony opłatą. Spokój bez stresu.',
      },
      {
        icon: 'headphones',
        title: 'Wsparcie 24/7',
  ...
  uk: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Сповіщення перед закінченням',
        description: 'Ви отримаєте сповіщення перед закінченням оренди, щоб завжди бути в курсі.',
      },
      {
        icon: 'clock',
        title: '30 хв. пільговий період',
        description: 'Якщо ви запізнитесь до 30 хвилин, жодної плати не буде. Спокій без стресу.',
      },
      {
        icon: 'headphones',
  ...
  fr: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Notification avant la fin',
        description: 'Recevez une notification avant la fin de votre location, pour être toujours informé.',
      },
      {
        icon: 'clock',
        title: '30 min. de période de grâce',
        description: 'Si vous êtes en retard jusqu\'à 30 minutes, aucun frais ne s\'applique. Tranquillité d\'esprit.',
      },
      {
        icon: 'headphones',
        title: 'Support 24/7',
  ...
  es: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Notificación antes del final',
        description: 'Recibe una notificación antes de que finalice tu alquiler, para estar siempre informado.',
      },
      {
        icon: 'clock',
        title: '30 min. período de gracia',
        description: 'Si llegas tarde hasta 30 minutos, no se aplica ningún cargo. Tranquilidad sin estrés.',
      },
      {
        icon: 'headphones',
        title: 'Soporte 24/7',
  ...
  it: {
    ...
    features: [
      ...
      {
        icon: 'bell',
        title: 'Notifica prima della scadenza',
        description: 'Ricevi una notifica prima della fine del noleggio, così sei sempre informato.',
      },
      {
        icon: 'clock',
        title: '30 min. periodo di tolleranza',
        description: 'Se sei in ritardo fino a 30 minuti, non verrà applicato alcun addebito. Tranquillità senza stress.',
      },
      {
        icon: 'headphones',
        title: 'Supporto 24/7',
